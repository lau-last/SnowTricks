 ...
 */
final class Version20230927130916 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE trick_picture (id INT AUTO_INCREMENT NOT NULL, trick_id INT NOT NULL, file_name VARCHAR(255) NOT NULL, alt VARCHAR(255) NOT NULL, first_picture TINYINT(1) NOT NULL, INDEX IDX_758636D1B281BE2E (trick_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, username VARCHAR(80) NOT NULL, email VARCHAR(255) NOT NULL, media VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, hash_token VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL, active TINYINT(1) NOT NULL, expiration_date INT NOT NULL, UNIQUE INDEX UNIQ_8D93D649F85E0677 (username), UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
